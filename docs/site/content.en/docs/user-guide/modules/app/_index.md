...
weight: 5
description: "The one module above every other group — go/app: the loader, the eight-stage component drive, the fixed middleware chain and the no-import bridges every host's boot composes through."
...
eight-stage component drive, the shutdown sequence and the HTTP
