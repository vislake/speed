...
- Design: [docs/internal/12-frontend.md](https://github.com/vislake/speed/blob/main/docs/internal/12-frontend.md)
  (bilingual text discipline and the frontend catalog)
- Package contract: [web/packages/i18n/README.md](https://github.com/vislake/speed/blob/main/web/packages/i18n/README.md)
