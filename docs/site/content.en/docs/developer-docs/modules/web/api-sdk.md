...
- Package contract: [web/packages/api-sdk/README.md](https://github.com/vislake/speed/blob/main/web/packages/api-sdk/README.md), [AGENTS.md](https://github.com/vislake/speed/blob/main/web/packages/api-sdk/AGENTS.md)
...
- Design: [docs/internal/21-api-contract.md](https://github.com/vislake/speed/blob/main/docs/internal/21-api-contract.md) (generation legs, merge policy, artifact gates), [12-frontend.md](https://github.com/vislake/speed/blob/main/docs/internal/12-frontend.md)
