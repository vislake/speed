...
const DESCRIPTION =
  ...
  'fragments (the notes and authn fragments today), regenerated by `task ' +
  'api:merge` and committed. Each module fragment stays authoritative for its ' +
  'own operations; this merged document is the frontend SDK\'s generation input ' +
  'and the linted whole-surface view (docs/internal/21-api-contract.md).'
