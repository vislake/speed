...
const DESCRIPTION =
  ...
  'fragments (the notes, cases, smilesim, authn and notification fragments ' +
  'today), regenerated by `task api:merge` and committed. Each module ' +
  'fragment stays authoritative for its own operations; this merged document ' +
  "is the frontend SDK's generation input and the linted whole-surface view " +
