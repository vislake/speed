 ...
 *
 * This is the same helper @speed/auth-ui's suite uses (packages cannot
 * share test utilities: each carries its own copy, since the helpers a
 * suite needs are not published artifacts).
 */
