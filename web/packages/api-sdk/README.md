...
generated frontend half of the API-contract discipline. Operation
...
exists anywhere, and generated query keys are plain path strings
without a tenant prefix -- tenant query-key namespacing is a
...
Compile consumption is live, and runtime end-to-end consumption has
its real host: the consumer shell.
