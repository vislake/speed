/**
 * account-ui test configuration: jsdom DOM environment with the shared
 ...
 * @speed/auth-core, @speed/api-sdk and @speed/i18n; test-utils/ renders
 * under the ui-kit theme providers -- whose own sources import
 * @speed/tokens and @speed/i18n/mui-locale, aliased below for the same
 * reason -- and drives sessions through the api-client and api-sdk seam.
 * Aliases match by prefix, so a subpath entry must come before the entry
 * that is its prefix: "@speed/i18n/mui-locale" before "@speed/i18n", and
