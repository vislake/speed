 ...
 * rendered form family can read are registered: the auth-ui namespace for
 * this package's own strings and the ui-kit namespace, because the
 * react-hook-form fields render through ui-kit's FormField, whose
 * required/invalid rules speak ui-kit-namespace keys ('form.required').
 * A fresh instance per call keeps registerNamespace's double-registration
 * guard from firing across tests.
 *
