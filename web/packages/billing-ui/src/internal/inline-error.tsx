 ...
 * belong to one alert). The code resolves to current-language text
 * through the error-text resolver -- whitelisted codes (billing.*,
 * authn.*, client.*) have their own errors-section key, anything else
 * renders the errors.unknown fallback, so no raw key and no
