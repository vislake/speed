...
func (d *document) renderMarkdown() string {
	...
	b.WriteString("<!-- Generated by tools/configrefgen (go run . from tools/configrefgen/). Do not hand-edit. Reference stats: " +
