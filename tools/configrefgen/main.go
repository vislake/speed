...
//     descriptor -- as a pkgcore.BootstrapKey on the BootstrapKeys seat or as
//     a derive-tagged ConfigSchema field -- and this command renders those
//     declarations -- what the key protects, its value
