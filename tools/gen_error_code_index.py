...
can gate the committed page. A struct literal whose Status cannot be read
...
against this file (run it next to --check).
"""
...
def render_markdown(entries: list[ErrorEntry]) -> str:
    ...
    lines.append(
        ...
        f"regenerate with python3 tools/gen_error_code_index.py, whose --check "
        f"mode reports drift. Index stats: {n_sites} construction "
