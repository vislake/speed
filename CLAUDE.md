...
- **Do not use `db.Table` / `db.Model` / `db.Raw` to work around the Repository.** No checker for this exists in CI yet — code review enforces it today (see Repository Status for what CI does run).
