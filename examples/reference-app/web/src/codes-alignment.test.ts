 ...
 * machine twin docs/error-codes.json
...
/**
 * The server-emittable codes of this app's surfaces, each cited by the
 * file and the sentinel identifier that define it: go/authn/errors.go
 * for the authn codes, go/rbac's ErrPermissionDenied for
 * rbac.permission_denied, and the notes module handler's own sentinels
 * for the notes codes.
 *
 * A citation carries its path and identifier only, never a line
 * number: nothing in this suite compares a line, and a line annotation
 * rots on every unrelated Go edit that inserts or removes a line above
 * the sentinel, so it is noise rather than an assertion. The machine
 * census (docs/error-codes.json, regenerated by
 * tools/gen_error_code_index.py) carries the line of every recorded
 * construction for a reader who needs one.
 *
 * The checks below assert the properties worth keeping. The deep check
 * asserts the cited FILE declares the identifier exactly once -- that
 ...
 * identifier named. The census check asserts the cited (code, file)
 * pair is a real construction of that code in the extracted census,
 * bound to the cited identifier when the row binds one.
 */
const GO_PINNED: Readonly<Record<string, string>> = {
  ...
  'authn.invalid_credentials': 'go/authn/errors.go (ErrInvalidCredentials)',
  'authn.identifier_required': 'go/authn/errors.go (ErrIdentifierRequired)',
  'authn.invalid_email': 'go/authn/errors.go (ErrInvalidEmail)',
  'authn.invalid_phone': 'go/authn/errors.go (ErrInvalidPhone)',
  ...
  'authn.invalid_locale': 'go/authn/errors.go (ErrInvalidLocale)',
  'authn.invalid_timezone': 'go/authn/errors.go (ErrInvalidTimezone)',
  'authn.email_already_registered': 'go/authn/errors.go (ErrEmailAlreadyRegistered)',
  'authn.phone_already_registered': 'go/authn/errors.go (ErrPhoneAlreadyRegistered)',
  'authn.password_too_short': 'go/authn/errors.go (ErrPasswordTooShort)',
  'authn.password_too_long': 'go/authn/errors.go (ErrPasswordTooLong)',
  'authn.display_name_too_long': 'go/authn/errors.go (ErrDisplayNameTooLong)',
  'authn.password_too_weak': 'go/authn/errors.go (ErrPasswordTooWeak)',
  ...
  'authn.token_invalid': 'go/authn/errors.go (ErrTokenInvalid)',
  'authn.token_expired': 'go/authn/errors.go (ErrTokenExpired)',
  'authn.session_revoked': 'go/authn/errors.go (ErrSessionRevoked)',
  'authn.refresh_token_invalid': 'go/authn/errors.go (ErrRefreshTokenInvalid)',
  'authn.refresh_token_reused': 'go/authn/errors.go (ErrRefreshTokenReused)',
  'authn.tenant_membership_required': 'go/authn/errors.go (ErrTenantMembershipRequired)',
  'authn.tenant_membership_unavailable': 'go/authn/errors.go (ErrTenantMembershipUnavailable)',
  'authn.oauth_state_invalid': 'go/authn/errors.go (ErrOAuthStateInvalid)',
  'authn.redirect_uri_not_allowed': 'go/authn/errors.go (ErrRedirectURINotAllowed)',
  'authn.provider_unknown': 'go/authn/errors.go (ErrProviderUnknown)',
  'authn.social_exchange_failed': 'go/authn/errors.go (ErrSocialExchangeFailed)',
  'authn.identity_requires_binding': 'go/authn/errors.go (ErrIdentityRequiresBinding)',
  'authn.identity_already_bound': 'go/authn/errors.go (ErrIdentityAlreadyBound)',
  'authn.identity_not_found': 'go/authn/errors.go (ErrIdentityNotFound)',
  'authn.last_login_method': 'go/authn/errors.go (ErrLastLoginMethod)',
  'authn.rate_limited': 'go/authn/errors.go (ErrRateLimited)',
  'authn.account_locked': 'go/authn/errors.go (ErrAccountLocked)',
  'authn.channel_disabled': 'go/authn/errors.go (ErrChannelDisabled)',
  'authn.verification_code_invalid': 'go/authn/errors.go (ErrVerificationCodeInvalid)',
  'authn.mfa_not_enrolled': 'go/authn/errors.go (ErrMFANotEnrolled)',
  'authn.mfa_already_enrolled': 'go/authn/errors.go (ErrMFAAlreadyEnrolled)',
  ...
  'authn.mfa_invalid_code': 'go/authn/errors.go (ErrMFAInvalidCode)',
  'authn.mfa_code_used': 'go/authn/errors.go (ErrMFACodeUsed)',
  'authn.step_up_required': 'go/authn/errors.go (ErrStepUpRequired)',
  'authn.session_not_found': 'go/authn/errors.go (ErrSessionNotFound)',
  // go/rbac/errors.go -- the permission-denied sentinel the notes route's
  // rbac gate answers with.
  'rbac.permission_denied': 'go/rbac/errors.go (ErrPermissionDenied)',
  // examples/reference-app/internal/notes/handler.go -- the notes module
  // handler's own sentinels.
  'notes.text_required': 'examples/reference-app/internal/notes/handler.go (ErrTextRequired)',
  // The two declarations below sit after the maxRequestBodyBytes
  // constant block above ErrTextTooLong.
  'notes.text_too_long': 'examples/reference-app/internal/notes/handler.go (ErrTextTooLong)',
  'notes.internal_error': 'examples/reference-app/internal/notes/handler.go (errInternal)',
  ...
  'cases.patient_name_required': 'examples/reference-app/internal/cases/service.go (ErrPatientNameRequired)',
  'cases.patient_name_too_long': 'examples/reference-app/internal/cases/service.go (ErrPatientNameTooLong)',
  'cases.photo_object_id_required': 'examples/reference-app/internal/cases/service.go (ErrPhotoObjectIDRequired)',
  'cases.photo_object_id_too_long': 'examples/reference-app/internal/cases/service.go (ErrPhotoObjectIDTooLong)',
  'cases.duplicate_photo_object': 'examples/reference-app/internal/cases/service.go (ErrDuplicatePhotoObject)',
  'cases.too_many_photos': 'examples/reference-app/internal/cases/service.go (ErrTooManyPhotos)',
  'cases.photo_already_attached': 'examples/reference-app/internal/cases/service.go (ErrPhotoAlreadyAttached)',
  'cases.not_found': 'examples/reference-app/internal/cases/service.go (ErrNotFound)',
  'cases.subject_unresolved': 'examples/reference-app/internal/cases/service.go (ErrSubjectUnresolved)',
  ...
  // content route).
  'cases.photo_content_required': 'examples/reference-app/internal/app/cases_photos.go (ErrPhotoContentRequired)',
  'cases.photo_content_invalid': 'examples/reference-app/internal/app/cases_photos.go (ErrPhotoContentInvalid)',
  'cases.photo_content_too_large': 'examples/reference-app/internal/app/cases_photos.go (ErrPhotoContentTooLarge)',
  'cases.photo_rejected': 'examples/reference-app/internal/app/cases_photos.go (ErrPhotoRejected)',
  'cases.photo_not_found': 'examples/reference-app/internal/app/cases_photos.go (ErrPhotoNotFound)',
  ...
  // site).
  'cases.internal_error': 'examples/reference-app/internal/app/cases.go (casesErrInternal)',
  'cases.invalid_request_body': 'examples/reference-app/internal/app/cases.go (casesInvalidRequestBody)',
  ...
  'smilesim.unsupported_smile_style': 'examples/reference-app/internal/smilesim/options.go (ErrUnsupportedSmileStyle)',
  'smilesim.unsupported_tooth_shade': 'examples/reference-app/internal/smilesim/options.go (ErrUnsupportedToothShade)',
  'smilesim.strength_out_of_range': 'examples/reference-app/internal/smilesim/options.go (ErrStrengthOutOfRange)',
  ...
  // route's refusals).
  'smilesim.internal_error': 'examples/reference-app/internal/app/smilesim.go (smileSimErrInternal)',
  'smilesim.invalid_request_body': 'examples/reference-app/internal/app/smilesim.go (smilesimErrInvalidRequestBody)',
  'smilesim.photo_object_id_required': 'examples/reference-app/internal/app/smilesim.go (smilesimErrPhotoObjectIDRequired)',
  'smilesim.simulation_not_found': 'examples/reference-app/internal/app/smilesim.go (smileSimErrSimulationNotFound)',
  'smilesim.output_not_ready': 'examples/reference-app/internal/app/smilesim.go (smileSimErrOutputNotReady)',
  'smilesim.output_not_found': 'examples/reference-app/internal/app/smilesim.go (smileSimErrOutputNotFound)',
  'smilesim.recipient_not_in_tenant': 'examples/reference-app/internal/app/smilesim.go (smilesimErrRecipientNotInTenant)',
  // go/jobs/job.go -- the not-found sentinel the job-status handler
  // passes through for an unknown or another tenant's job id.
  'jobs.job_not_found': 'go/jobs/job.go (ErrJobNotFound)',
  ...
  'billing.insufficient_credits': 'go/billing/errors.go (ErrInsufficientCredits)',
  ...
  'billing.internal_error': 'go/billing/errors.go (ErrInternal)',
  ...
  'aigateway.entitlement_denied': 'go/ai-gateway/errors.go (ErrEntitlementDenied)',
  ...
  'sharing.internal_error': 'go/sharing/errors.go (ErrInternal)',
  'sharing.not_accessible': 'go/sharing/errors.go (ErrNotAccessible)',
  'sharing.resource_unavailable': 'go/sharing/errors.go (ErrResourceUnavailable)',
  'sharing.rate_limited': 'go/sharing/ratelimit.go (ErrRateLimited)',
  ...
  // (go/rbac/errors.go).
  'org.invalid_email': 'go/org/errors.go (ErrInvalidEmail)',
  'org.invitation_rate_limited': 'go/org/errors.go (ErrInvitationRateLimited)',
  'org.invitations_disabled': 'go/org/errors.go (ErrInvitationsDisabled)',
  'org.node_not_found': 'go/org/errors.go (ErrNodeNotFound)',
  'org.internal_error': 'go/org/errors.go (ErrInternal)',
}
...
const WHITELISTED_BEYOND_THIS_APP: Readonly<Record<string, string>> = {
  ...
  // go/authn/errors.go (ErrAuthenticationRequired) -- the sentinel
...
/** A citation's path and sentinel identifier -- the two halves the deep
 * check and the census check below consume. */
interface SentinelCitation {
  readonly path: string
  readonly identifier: string
}

/** Parses a citation of the shape 'path (Identifier)'. */
function parseCitation(code: string, citation: string): SentinelCitation {
  const match = /^(\S+) \(([^)]+)\)$/.exec(citation)
  const path = match?.[1]
  const identifier = match?.[2]
  if (path === undefined || identifier === undefined) {
...
describe('reachable-error whitelists vs the server code set', () => {
  it('declares every GO_PINNED sentinel exactly once in the file its citation names', () => {
    // The identifier half of the citation discipline (see the GO_PINNED
    // doc comment): the cited FILE must declare the cited sentinel
    // exactly once, so a sentinel deleted or renamed (the identifier
    // vanishes from the file) and a citation pointed at the wrong file
    // (the identifier is not declared there) both fail this suite with
    // the code, the file and the identifier named. A sentinel that
    // merely moves within its file is no drift at all -- citations
    // carry no line number, and where a sentinel sits is the machine
    // census's business (docs/error-codes.json).
  ...
  it('machine-verifies every GO_PINNED code against the extracted error-code census', () => {
    ...
    // regenerated by that same generator, whose --check mode reports a
    // stale JSON. The identifier-level test above proves the cited
