// Package migrations embeds notes' versioned SQL migration files, one
// subdirectory per SQL dialect, for notes.Module's Migrations() method.
//
...
// FS embeds notes' postgres/*.sql and sqlite/*.sql migration files.
//
