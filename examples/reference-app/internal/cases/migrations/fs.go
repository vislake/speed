// Package migrations embeds the case domain's versioned SQL migration
// files, one subdirectory per SQL dialect, for the "cases" component's
// Migrations declaration.
//
...
// FS embeds the case domain's postgres/*.sql and sqlite/*.sql migration
// files.
//
