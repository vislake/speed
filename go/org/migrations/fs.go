// Package migrations embeds the org module's versioned SQL migration files,
// one subdirectory per SQL dialect, for org.Module's Migrations() method.
//
...
// are its own immediate children. This mirrors go/config/migrations and
// examples/reference-app/internal/notes/migrations; see go/dbkit/AGENTS.md's
// "Migrations" section.
package migrations

import "embed"

// FS embeds the org module's postgres/*.sql and sqlite/*.sql migration
// files.
//
