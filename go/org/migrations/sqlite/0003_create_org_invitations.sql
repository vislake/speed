...
-- column type is the dialect's binary type (BLOB here, BYTEA in the postgres/ sibling).
--
...
-- rationale. The only difference between the two files is the binary column
-- type, which is the one place the dialects genuinely disagree.
