// Package migrations embeds the notification module's versioned SQL
// migration files, one subdirectory per SQL dialect, for notification's
// Module.Migrations() method.
//
...
// go/config/migrations.
package migrations

import "embed"

// FS embeds the notification module's postgres/*.sql and sqlite/*.sql
// migration files.
//
