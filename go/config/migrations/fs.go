// Package migrations embeds the config module's versioned SQL migration
// files, one subdirectory per SQL dialect, for config.Module's Migrations()
// method.
//
...
// examples/reference-app/internal/notes/migrations and dbkit's own
// internal migration fixture; see go/dbkit/AGENTS.md's "Migrations"
// section.
package migrations

import "embed"

// FS embeds the config module's postgres/*.sql and sqlite/*.sql migration
// files.
//
