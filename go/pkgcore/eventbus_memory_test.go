...
// eventbus_memory.go registers directly, "eventbus.memory", and the
...
// example_test.go blank-imports it so the shared EventBusRegistry carries it
// too by the time any test in this package runs.
