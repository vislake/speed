...
// default for -- an SMTP relay host (smtpMailerFromConfig, mailer_registry.go),
...
// called by the four seam registry builders this package's seam
// registration files define (newBuiltinEventBusRegistry in
// eventbus_memory.go, newBuiltinKVStoreRegistry in kv_memory.go,
// newBuiltinMailerRegistry in mailer_registry.go and
// newBuiltinObjectStoreRegistry in objectstore_registry.go), against names
