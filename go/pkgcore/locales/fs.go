// Package locales is pkgcore's own message bundle: the zh-CN.toml and
// en-US.toml files every module ships, embedded for Kernel.Bootstrap to feed
// to i18n.Builder.AddModule alongside every other module's Locales()
// embed.FS.
//
...
// be dropped. Every other module ships its own pair of files in its own
// module directory, following the flat one-entry-per-message contract
// documented in go/pkgcore/i18n.
package locales
