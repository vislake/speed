// Package locales holds the billing module's message bundle: one
...
// code go/billing/errors.go declares, one flat entry per code, with the
...
// FS holds billing's locale files, flat at the embed root: exactly
