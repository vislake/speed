...
// is an interface declared here and implemented by the host (the org
// module among them), so that rbac never imports another business
// module's structs.
//
...
// node moves in the tree, and a member's permissions must follow such a
// move immediately.
