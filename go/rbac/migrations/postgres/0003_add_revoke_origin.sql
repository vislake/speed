...
-- untouched. This is standard SQL, not a PostgreSQL-specific feature -- the
-- identical DDL string runs on SQLite too (see the sqlite/ sibling) -- no
-- PostgreSQL-only type, no gen_random_uuid(), no NOW().
