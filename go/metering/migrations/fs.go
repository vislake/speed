// Package migrations embeds the metering module's versioned SQL migration
// files, one subdirectory per SQL dialect, for metering.Module's
// Migrations() method.
//
...
// are its own immediate children. This mirrors go/org/migrations,
// go/storage/migrations and go/pki/migrations; see go/dbkit/AGENTS.md's
// "Migrations" section.
package migrations

import "embed"

// FS embeds the metering module's postgres/*.sql and sqlite/*.sql
// migration files.
//
