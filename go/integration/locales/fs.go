// Package locales holds the integration module's message bundle: one
...
// code go/integration/errors.go declares, one flat entry per code, with the
...
// FS holds integration's locale files, flat at the embed root: exactly
