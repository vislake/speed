// Package migrations embeds the integration module's versioned SQL
// migration files, one subdirectory per SQL dialect, for
// integration.Module's Migrations() method.
//
...
// its own immediate children. This mirrors go/org/migrations, go/storage/
// migrations and go/pki/migrations; see go/dbkit/AGENTS.md's "Migrations"
// section.
package migrations

import "embed"

// FS embeds the integration module's postgres/*.sql and sqlite/*.sql
// migration files.
//
