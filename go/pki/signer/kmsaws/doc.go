...
// count "// indirect" entries). The measurement uses only
...
// # exactly right
//
// A distinction that is easy to get subtly,
...
// is known to diverge from the real service, so a testcontainers-backed
