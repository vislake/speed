...
// alone. This round ships no integration_test/ package that calls it yet --
// see go/pki/AGENTS.md's Known limitations -- but the helper is included
// now so a later round's PostgreSQL leg needs no db.go of its own.
