...
-- copy of this file): no dialect-specific types, no gen_random_uuid()
-- (IDs are ULIDs generated in the application), no NOW() (timestamps use
-- GORM's autoCreateTime/autoUpdateTime when a model needs them; Widget
-- does not).
--
