// Package migrations embeds the sharing module's versioned SQL migration
// files, one subdirectory per SQL dialect, for sharing.Module's Migrations()
// method.
//
...
// FS embeds the sharing module's postgres/*.sql and sqlite/*.sql migration
// files.
//
