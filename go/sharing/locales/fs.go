// Package locales holds the sharing module's message bundle: one
...
// code go/sharing/errors.go declares, one flat entry per code, with the id
// equal to the code itself -- the same convention org, storage, notification
...
// FS holds sharing's locale files, flat at the embed root: exactly
