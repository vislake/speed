...
// go/pki/internal/testutil.NewSQLite's identical shape and reasoning.
...
// needs in order to apply one module's migration files, mirroring
// go/pki/internal/testutil's identical helper type.
