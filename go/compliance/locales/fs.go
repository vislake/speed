// Package locales holds the compliance module's message bundle: one
...
// code go/compliance/errors.go declares, one flat entry per code, with
// the id equal to the code itself -- the same convention org, storage,
// notification, pki and metering's own locale bundles follow.
//
...
// FS holds compliance's locale files, flat at the embed root: exactly
