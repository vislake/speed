...
// without subscribing to any of them. Register declares both up front, so
...
// itself be in the bootstrap set -- DependsOn enumerates only modules in
// that set, exactly as org's identical answer explains.
